---
title: "Estadística:"
subtitle: "Tablas y Gráficos<html><div style='float:left'></div><hr color='#EB811B' size=1px width=800px></html>"
...
# Tablas de frecuencias: `table()`, `prop.table()`, `xtabs()` y `count()`
...
# Ejemplo [EVA 2019-2020](https://www.datos.gov.co/Agricultura-y-Desarrollo-Rural/Evaluaciones-Agropecuarias-Municipales-EVA-2019-20/p5fp-pay3)
<html><div style='float:left'></div><hr color='#EB811B' size=1px width=720px></html> 

<center>
<img src="https://www.upra.gov.co/documents/10184/213756/20211019_banner_PortadaEVA.jpg/ff8060a6-8ca4-4cad-9874-dce3e5ac2d45?t=1634779338117"/>
</center>
