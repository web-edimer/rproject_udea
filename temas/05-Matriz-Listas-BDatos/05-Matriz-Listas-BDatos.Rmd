...
### Formatos planos
  ...
  - [IMC - Separados por comas (.csv o .txt)](/temas/05-Matriz-Listas-BDatos/data/imc_total_comas.csv)
  - [IMC - Separados por punto y comas (.csv o .txt)](/temas/05-Matriz-Listas-BDatos/data/imc_total_puntocomas.csv)
  - [IMC - Separados por espacios o tabulaciones (.csv o .txt)](/temas/05-Matriz-Listas-BDatos/data/imc_total_espacios.csv)
  - [IMC - Separados por otro delimitador (.csv o .txt)](/temas/05-Matriz-Listas-BDatos/data/imc_total_otrodelim.csv)
